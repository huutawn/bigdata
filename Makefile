...
REPLAY_OUTPUT_JSONL ?=
REPLAY_REPEAT ?= 0
REPLAY_PUBLISH_FAST ?= 0
STREAM_USE_ORIGINAL_EVENT_TIME_LOCAL ?= 0
...
start-replay:
> $$env:GENERATOR_SOURCE_DIR='$(REPLAY_INPUT)'; $$env:GENERATOR_REPLAY_TIME_SCALE='$(REPLAY_TIME_SCALE)'; $$env:GENERATOR_SESSION_GAP_MINUTES='$(REPLAY_SESSION_GAP_MINUTES)'; $$env:GENERATOR_REPLAY_FLUSH_EVERY='$(REPLAY_FLUSH_EVERY)'; $$env:GENERATOR_REPLAY_FLUSH_TIMEOUT_SECONDS='$(REPLAY_FLUSH_TIMEOUT_SECONDS)'; $$env:GENERATOR_REPLAY_FLUSH_RETRY_ATTEMPTS='$(REPLAY_FLUSH_RETRY_ATTEMPTS)'; $$env:GENERATOR_REPLAY_FLUSH_RETRY_BACKOFF_SECONDS='$(REPLAY_FLUSH_RETRY_BACKOFF_SECONDS)'; $$env:GENERATOR_REPLAY_PROGRESS_EVERY='$(REPLAY_PROGRESS_EVERY)'; $$env:GENERATOR_REPLAY_MAX_RECORDS='$(REPLAY_MAX_RECORDS)'; $$env:GENERATOR_REPLAY_OUTPUT_JSONL='$(REPLAY_OUTPUT_JSONL)'; $$env:GENERATOR_REPEAT='$(REPLAY_REPEAT)'; $$env:GENERATOR_REPLAY_PUBLISH_FAST='$(REPLAY_PUBLISH_FAST)'; & $(DEV_SCRIPT) start-replay

start-stream:
> $$env:STREAM_USE_ORIGINAL_EVENT_TIME='$(STREAM_USE_ORIGINAL_EVENT_TIME_LOCAL)'; & $(DEV_SCRIPT) start-stream
...
> if [ '$(REPLAY_PUBLISH_FAST)' = '1' ]; then REPLAY_ARGS+=(--publish-fast); fi
> KAFKA_BOOTSTRAP_SERVERS='$(KAFKA_BOOTSTRAP_SERVERS_LOCAL)' \
> KAFKA_TOPIC='$(KAFKA_TOPIC_LOCAL)' \
...
> GENERATOR_REPLAY_PUBLISH_FAST='$(REPLAY_PUBLISH_FAST)' \
> PYTHONPATH='$(ROOT)/generator/src' \
...
> KAFKA_BOOTSTRAP_SERVERS='$(KAFKA_BOOTSTRAP_SERVERS_LOCAL)' \
> KAFKA_TOPIC='$(KAFKA_TOPIC_LOCAL)' \
> STREAM_USE_ORIGINAL_EVENT_TIME='$(STREAM_USE_ORIGINAL_EVENT_TIME_LOCAL)' \
